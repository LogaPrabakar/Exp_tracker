...
import { X, Edit3, Calendar, Tag, FileText } from 'lucide-react';
...
const EditExpenseModal: React.FC<EditExpenseModalProps> = ({ expense, onClose, onSubmit }) => {
      ...
      <div className="glass max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-primary-100">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-primary-800">Edit Expense</h2>
          </div>
          <button
            onClick={onClose}
